/**
 * Fallback app JS: loads if external compiled app.js is unavailable.
 * Provides product fetch, cart management, search, and UI updates.
 * Requires window.App config (routes + csrfToken) to be set in the Blade view.
 */
...
(function () {
    ...
    async function fetchProducts() {
        try {
            ...
            if (!res.ok) throw new  ('Products fetch failed');
